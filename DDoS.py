# ----------------------------------------------------------------------
# DDoS Attacks By : Mr.H1DD3N
# Follow me on Instagram : mr.h1dd3n_
# Visit my blog http://trampilotodidak.ga/
# Thanks To : ALL MEMBER ISLAMIC CYBER AND ALL MEMBER SECURITY DARKNET
# ---------------------------------------------------------------------
...
print \
    ...
    # Thanks To : ALL MEMBER ISLAMIC CYBER AND ALL MEMBER SECURITY DARKNET #
    # Visit My Blog : ( http://trampilotodidak.ga/ )                       #
    # Our Partner   : ( http://islamic-cyber.tk/ )                         #
    #                 ( http://indoscrty.tk/ )                             #
    #                 ( https://security-darknet.blogspot.co.id/ )         #
    ########################################################################
